...
import UIKit
import Foundation
import ParseSwift // TODO: Pt 1 - Import Parse Swift
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "xXSpQosEVSyfaGwcTUVtpCKXJP7zXGpJLgnJhsYM",
                              clientKey: "3BhwBDLbXoG76R6pyyCnWda8d5gA3jsOgoeibOSk",
